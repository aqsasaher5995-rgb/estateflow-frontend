...
const PropertyDetailPage = () => {
  ...
  const loadPropertyData = async () => {
    try {
      setLoading(true);
      const res = await fetch(`https://estateflow-backend-mt7ox7s2k-aqsasaher5995-rgbs-projects.vercel.app/api/properties/${id}`);
  ...
  const fetchReviews = async (propertyId) => {
    try {
      const res = await fetch(`https://estateflow-backend-mt7ox7s2k-aqsasaher5995-rgbs-projects.vercel.app/api/properties/${propertyId}/reviews`);
      const data = await res.json();
      if (data.success) {
  ...
  const handleReviewSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://estateflow-backend-mt7ox7s2k-aqsasaher5995-rgbs-projects.vercel.app/api/properties/${property.id}/reviews`, {
  ...
  return (
    <div style={{ background: '#080b11', minHeight: '100vh', color: 'white' }}>
      ...
      {/* HEADER with Logo */}
      <div className="glass-header" style={{ position: 'sticky', top: 0, zIndex: 100, padding: '16px 24px', background: 'rgba(8, 11, 23, 0.85)', backdropFilter: 'blur(12px)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
